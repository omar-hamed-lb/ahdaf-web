    ...
    <div className="2xl:container lg:mx-auto md:text-lg xl:text-xl">
      ...
      <section className="min-h-screen flex items-center justify-center">
        <div className="w-full max-w-4xl p-6">
          <h1 className="text-4xl font-bold text-center text-cgreen mb-2 mt-6">Ramadan 2025 Campaign</h1>
          <h1 className="text-4xl font-bold text-center text-cgreen mb-6">#ATA’UKA_ALLAMANI</h1>
